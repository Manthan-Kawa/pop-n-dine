...
>
  <motion.div
    ...
    className="bg-white rounded-2xl max-w-md w-full mx-4 shadow-xl relative overflow-y-auto max-h-[90vh] p-6 sm:p-8 print:bg-white print:max-h-none print:overflow-visible"
  ...
  >
    ...
    >
      <div className="text-center">
        <h3 className="text-lg font-semibold text-gray-800">₹{total.toFixed(2)}</h3>
        <p className="text-md text-black-500">Payment Amount</p>
      </div>

      <div className="space-y-1 border-t pt-4 text-lg text-gray-700">
        {items.map((item) => (
      ...
      <div className="space-y-1 border-t pt-3 ">
        ...
        <div className="flex justify-between text-base font-large text-black-800  pb-3">
          <span>SGST (9%)</span>
        ...
        <div className="flex justify-between text-base font-semibold text-black pt-2 border-t">
          <span>Total</span>
          <span className="flex justify-between text-base font-medium text-black-800">₹{total.toFixed(2)}</span>
        </div>
      </div>
